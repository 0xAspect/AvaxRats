...
import ratCycle from "../assets/images/ratCycle.png";
    ...
    <div className="about">
      <div class="container-fluid bg-light text-dark p-7">
        <div class="container bg-light p-5">
          <h1>
            Stake <span style={trinketStyle}>TRINKETS</span> to earn{" "}
            <a style={nibbleStyle}>NIBBLES.</a>
          </h1>
          <p></p>
          <h4>
            Feed <a style={nibbleStyle}>NIBBLES</a> to your RATS to level them
            up!
          </h4>
          <img style={{ height: "200px" }} src={ratCycle}></img>
        </div>
      </div>
                  ...
                  {props.isConnected === true ? (
                    <div style={{ textAlign: "center" }}>
                      ...
                      <a>
                        {props.isLive === true ? (
                          <>
                            <button class="button-54" onClick={handleStake}>
                              Stake{" "}
                            </button>
                            <button class="button-54" onClick={handleUnstake}>
                              Unstake{" "}
                            </button>
                          </>
                        ) : (
                          <button class="button-54">(SOON!) </button>
                        )}
                      </a>
                    </div>
                  ) : (
                    <button class="button-54" onClick={props.web3Enabled}>
                      Connect to farm!
                    </button>
                  )}
                </>
              ...
              <div className="col" style={{ marginBottom: "100px" }}>
                <Card style={cardStyleNib}>
                  <Card.Body>
                        ...
                        <tbody class="table table-borderless">
                          ...
                          <tr>
                            <td>
                              ...
                              <a>
                                {(
                                  Math.round(props.unclaimedNibbles * 100) / 100
                                ).toLocaleString()}
                              </a>
                            </td>
                            <td>
                              {" "}
                              {(
                                Math.round(props.nibblesBalance * 100) / 100
                              ).toLocaleString()}
                            </td>
                          </tr>
                        </tbody>
                    ...
                    <button class="button-54" onClick={claimYield}>
                      CLAIM NIBBLES
                    </button>
                  </Card.Body>
                </Card>
